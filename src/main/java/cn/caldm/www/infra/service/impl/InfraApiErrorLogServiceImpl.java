...
import cn.caldm.www.infra.mapper.InfraApiErrorLogMapper;
 ...
 */
@Service
public class InfraApiErrorLogServiceImpl implements InfraApiErrorLogService {
    @Autowired
    private InfraApiErrorLogMapper infraApiErrorLogMapper;

    @Override
    @Async
    public void createApiErrorLogAsync(InfraApiErrorLog errorLog) {
