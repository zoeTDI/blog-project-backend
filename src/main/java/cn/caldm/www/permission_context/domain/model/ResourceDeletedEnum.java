...
@Getter
public enum ResourceDeletedEnum {
    NORMAL(0, "未删除"),
    DELETED(1, "已删除");
    ...
    ResourceDeletedEnum(Integer code, String desc) {
        this.code = code;
        this.desc = desc;
    }

    // 根据 code 获取枚举
    public static ResourceDeletedEnum fromCode(Integer code) {
        if (code == null) return null;
        for (ResourceDeletedEnum status : values()) {
